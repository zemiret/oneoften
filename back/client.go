...
var (
	clientSeqNumber int
	clientSeqLocker sync.Mutex
)

func getClientSeqNumber() int {
...
func serveWs(hub *Hub, w http.ResponseWriter, r *http.Request) {
	...
	client := &Client{hub: hub, conn: conn, send: make(chan []byte, 256), seqNumber: seqNumber}
